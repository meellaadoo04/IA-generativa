...
param openAi_4_DeploymentName string = 'gpt-4o-mini'


@description('The name of the 4 eval OpenAI deployment')
param openAi_4_eval_DeploymentName string = 'gpt-4o'
...
module apiContainerApp 'app/api.bicep' = {
  ...
  params: {
    ...
    openAi_4_DeploymentName: 'gpt-4o-mini' 
    openAi_4_eval_DeploymentName: 'gpt-4o' 
    openAiEmbeddingDeploymentName: openAiEmbeddingDeploymentName
    openAiEndpoint: 'https://openai-tajamar-1.openai.azure.com/' 
    openAiName: 'openai-tajamar-1' 
...
output AZURE_OPENAI_ENDPOINT string = 'https://openai-tajamar-1.openai.azure.com/' 
output AZURE_OPENAI_NAME string = 'openai-tajamar-1' 
output AZURE_OPENAI_RESOURCE_GROUP string = 'openai' 
output AZURE_AI_PROJECT_NAME string = 'openai' 
output AZURE_OPENAI_RESOURCE_GROUP_LOCATION string = 'eastus' 
